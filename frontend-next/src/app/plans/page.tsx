...
const plans = [
  {
    ...
    features: ['50 عميل', '300 قرض', 'لوحة تحكم أساسية', 'تقارير شهرية', 'دعم بريد إلكتروني'],
    highlight: false,
  },
  {
    name: 'الاحترافية',
    ...
    features: ['500 عميل', '5,000 قرض', 'موظف إضافي', 'تقارير يومية', 'تحليلات AI', 'رفع ملفات Excel'],
    highlight: true,
  },
  {
    name: 'المؤسسية',
    ...
    features: ['عملاء بلا حدود', 'قروض بلا حدود', 'صلاحيات متقدمة', 'تقارير فورية', 'دعم أولوية 24/7'],
    highlight: false,
  },
] as const;
